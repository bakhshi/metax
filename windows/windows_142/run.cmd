...
rem Checks Visual Studio Community 2019
if defined VisualStudioVersion (
	...
	if exist "C:\Program Files\Microsoft Visual Studio\2019\Community\Common7\Tools\VsDevCmd.bat" (
		...
		if exist "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\Tools\VsDevCmd.bat" (
			...
			echo # FAIL:
			echo # Can not find Visual Studio 2019 version environment variable.
			echo # Need to install Visual Studio Community 2019
			echo # Or to run from Developer Command Prompt for VS2019
