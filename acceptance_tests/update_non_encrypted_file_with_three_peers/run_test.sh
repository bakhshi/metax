...
# - Sends "data" save request for a random generated file 
#   (should be saved as non-encrypted).
# - Waits about 5 second for backup then sends update request with a new generated file.
# - Waits about 15 seconds, checks if backup succeeded, then kills all running metaxes.
