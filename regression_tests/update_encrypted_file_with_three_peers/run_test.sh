...
# - Sends "data" save request for a random generated file (should be saved as encrypted).
# - Waits about 5 second for backup then sends update request.
# - Waits about 15 second, checks if backup succeeded, then kills all running metaxes.
