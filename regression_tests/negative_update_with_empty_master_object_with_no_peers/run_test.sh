...
main()
{
        ...
        save=$(curl --data "save content" http://localhost:7081/db/save/node?enc=0)
        ...
        echo $update
        expected='{"error":"Failed updating uuid='$uuid'. Master object is not valid or encrypted but key not found."}'
