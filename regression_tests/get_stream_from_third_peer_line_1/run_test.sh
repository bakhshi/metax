...
# - Send save stream request to metax1 (saved in metax2).
# - Send get request for previously saved stream to metax2 (getting from metax2).
...
main()
{
        ...
        curl "http://localhost:7101/db/get?id=283abccd-8c1e-47c1-8795-839abcfede5c" --output $test_dir/get_file
