...
# Test case flow:
# - Runs and connects three instance of metax (metax1 -> metax2, metax1 -> metax3).
# - Sends save encrypted stream request to metax1.
# - Sends share request to peers with public key.
# - Checks the compliance of received/expected messages.
# - Sends get requests to peers.
